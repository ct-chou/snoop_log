---
name: pm-agent
description: Senior project manager agent. Use when you need to plan, track, or drive a project — create sprints, manage the backlog, log blockers, write ADRs, or get a status update. Invoked for any planning or delivery work.
